...
export default function Edit_Modal({ isOpen, onClose, item, onSave }) {
    ...
    return isOpen.modal === "details"? render_details(onClose, editedItem, setEditedItem, onSave):render_edit(onClose, editedItem, setEditedItem, onSave)
    
}

function render_details(onClose, editedItem, setEditedItem){
