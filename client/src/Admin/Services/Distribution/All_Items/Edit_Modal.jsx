  ...
  const [requests, setRequests] = useState([
    {
      ...
      quantity: 5,
      status: 'Waiting',
      request_note: 'Request for initial supply.',
      schedule_date: '2024-08-15',
      approval_date: null,
      created_at: '2024-07-28T10:00:00',
      updated_at: '2024-07-28T10:00:00',
    },
    {
      id: 2,
      account_id: 102,
      ...
      quantity: 3,
      status: 'Approved',
      request_note: 'Urgent request for damaged plants.',
      schedule_date: '2024-08-20',
      approval_date: '2024-07-29T14:30:00',
      created_at: '2024-07-29T08:00:00',
      updated_at: '2024-07-29T14:30:00',
    },
  ]);
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
        <div className="bg-white rounded-lg p-8">Loading requests...</div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
        <div className="bg-white rounded-lg p-8">Error: {error.message}</div>
      </div>
    );
  }
  return (
              ...
              <div>
                ...
                <span className="block text-sm text-gray-700">
                  {editedItem.created_at
                    ? new Date(editedItem.created_at).toLocaleDateString(
                        undefined,
                        {
                          year: 'numeric',
                          month: 'long',
              ...
              <div>
                ...
                <span className="block text-sm text-gray-700">
                  {editedItem.updated_at
                    ? new Date(editedItem.updated_at).toLocaleDateString(
                        undefined,
                        {
                          year: 'numeric',
                          month: 'long',
