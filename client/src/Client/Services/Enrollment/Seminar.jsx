                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col justify-between flex-1 px-6 py-6">
                                            ...
                                            <div className="flex gap-3 w-full justify-end mt-6">
                                                <button className="flex items-center gap-2 px-8 py-2 rounded-xl bg-white text-green-900 font-bold shadow-lg hover:bg-green-100 transition text-base focus:outline-none focus:ring-2 focus:ring-green-400" disabled>
