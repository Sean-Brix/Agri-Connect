    ...
    return (
        <nav className="bg-white shadow-lg fixed w-full z-30 top-0 left-0">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-2 md:px-8 py-6">
                {/* Logo */}
                <svg className="w-8 h-8 text-green-600 ml-4" viewBox="0 0 32 32" fill="none" aria-hidden="true">
                    <circle cx="16" cy="16" r="15" stroke="currentColor" strokeWidth="2" fill="#bbf7d0"/>
                    <path d="M10 20c0-4 6-10 6-10s6 6 6 10a6 6 0 01-12 0z" fill="#22c55e" stroke="#166534" strokeWidth="1.5"/>
                    <ellipse cx="16" cy="20" rx="4" ry="2" fill="#a3e635"/>
                    <path d="M16 10v4" stroke="#166534" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
                <a href="/" className="flex items-center gap-2 font-extrabold text-2xl px-2  text-blue-700 md:text-2xl">
                    FITS -Tanza
                </a>
                {/* Desktop Menu */}
                    ...
                    <ul className="hidden md:flex items-center gap-2 lg:gap-6">
                        ...
                        <li className="relative group">
                            ...
                            >
                                ...
                                <svg className={`w-4 h-4 ml-1 transition-transform duration-200 ${servicesOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path d="M19 9l-7 7-7-7" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </button>
                            {/* Dropdown */}
                            <ul className={`absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-lg py-4 z-40 border border-blue-100 transition-all duration-200 ${
                                servicesOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 -translate-y-2 pointer-events-none'
                            }`}>
                                <li>
                                    <a href="/seminar-programs" className="flex items-center gap-3 px-6 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="/eic" className="flex items-center gap-3 px-6 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        ...
                        <li className="relative group">
                            ...
                            >
                                ...
                                {!isMidScreen && "Info"}
                                <svg className={`w-4 h-4 ml-1 transition-transform duration-200 ${infoOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path d="M19 9l-7 7-7-7" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </button>
                            {/* Dropdown */}
                            <ul className={`absolute left-0 mt-2 w-44 bg-white rounded-xl shadow-lg py-2 z-40 border border-blue-100 transition-all duration-200 ${
                                infoOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 -translate-y-2 pointer-events-none'
                            }`}>
                                <li>
                                    <a href="/about" className="flex items-center gap-2 px-6 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="/contact" className="flex items-center gap-2 px-6 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        ...
                        <li className="relative group">
                            ...
                            >
                                ...
                                <svg className={`w-4 h-4 ml-1 transition-transform duration-200 ${settingsOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path d="M19 9l-7 7-7-7" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </button>
                            {/* Dropdown */}
                            <ul className={`absolute left-0 mt-2 w-44 bg-white rounded-xl shadow-lg py-2 z-40 border border-blue-100 transition-all duration-200 ${
                                ...
                                <li>
                                    <a href="/settings/profile" className="flex items-center gap-2 px-6 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="/settings/account" className="flex items-center gap-2 px-6 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        ...
                        >
                            {isLoggedIn ? (
                                <>
                                    ...
                                    />
                                    {!isMidScreen && <span className="font-semibold">{user.name}</span>}
                                </>
                            ) : (
                                <span>Login</span>
                            )}
            ...
            >
                <div className="flex items-center justify-between px-6 py-8 border-b border-blue-100">
                    <svg className="w-8 h-8 text-green-600 " viewBox="0 0 32 32" fill="none" aria-hidden="true">
                    <circle cx="16" cy="16" r="15" stroke="currentColor" strokeWidth="2" fill="#bbf7d0"/>
                    <path d="M10 20c0-4 6-10 6-10s6 6 6 10a6 6 0 01-12 0z" fill="#22c55e" stroke="#166534" strokeWidth="1.5"/>
                    <ellipse cx="16" cy="20" rx="4" ry="2" fill="#a3e635"/>
                    <path d="M16 10v4" stroke="#166534" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
                <a href="/" className="flex items-center font-extrabold text-2xl px-2 mr-10  text-blue-700 md:text-2xl">
                    FITS -Tanza
                </a>
                    <button
                        onClick={() => setOpen(false)}
                ...
                <div className="flex flex-col items-center gap-4 py-10 border-b border-blue-100 bg-gradient-to-b from-blue-50 to-white">
                    {isLoggedIn ? (
                        <>
                            ...
                            <span className="font-semibold text-blue-800 text-lg">{user.name}</span>
                            <a
                                href="/profile"
                ...
                <ul className="flex flex-col gap-2 px-8 py-8">
                    <li>
                        <a href="/" className="flex items-center gap-2 px-6 py-4 text-blue-700 hover:bg-blue-50 font-semibold rounded-lg transition">
                            <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                <path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0h6" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            Home
                    ...
                    <li>
                        <details className="group">
                            <summary className="flex items-center gap-2 px-6 py-4 text-blue-700 hover:bg-blue-50 font-semibold rounded-lg cursor-pointer transition focus:outline-none">
                                <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path d="M4 6h16M4 12h16M4 18h16" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                Services
                                <svg className="w-4 h-4 ml-1 transition-transform duration-200 group-open:rotate-180" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path d="M19 9l-7 7-7-7" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </summary>
                            <ul className="bg-white rounded-xl shadow-lg py-4 mt-2 border border-blue-100">
                                <li>
                                    <a href="/seminar-programs" className="flex items-center gap-3 px-8 py-4 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <path d="M8 17l4 4 4-4m-4-5v9" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M20 12a8 8 0 10-16 0 8 8 0 0016 0z" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                ...
                                <li>
                                    <a href="/eic" className="flex items-center gap-3 px-8 py-4 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <rect x="4" y="4" width="16" height="16" rx="4" stroke="currentColor" strokeWidth="2" />
                                            <path d="M8 12h8" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                    ...
                    <li>
                        <details className="group">
                            ...
                            <ul className="bg-white rounded-xl shadow-lg py-2 mt-2 border border-blue-100">
                                <li>
                                    <a href="/about" className="flex items-center gap-2 px-8 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <path d="M13 16h-1v-4h-1m1-4h.01" strokeLinecap="round" strokeLinejoin="round"/>
                                            <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/>
                                        </svg>
                                ...
                                <li>
                                    <a href="/contact" className="flex items-center gap-2 px-8 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <path d="M21 10.5V6a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2h5.5" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M21 10.5l-9 6.5-9-6.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                    ...
                    <li>
                        <details className="group">
                            ...
                            <ul className="bg-white rounded-xl shadow-lg py-2 mt-2 border border-blue-100">
                                <li>
                                    <a href="/settings/profile" className="flex items-center gap-2 px-8 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <circle cx="12" cy="7" r="4" />
                                            <path d="M5.5 21a8.38 8.38 0 0113 0" />
                                        </svg>
                                ...
                                <li>
                                    <a href="/settings/account" className="flex items-center gap-2 px-8 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition font-medium">
                                        <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <rect x="3" y="7" width="18" height="13" rx="2" />
                                            <path d="M16 3v4M8 3v4" />
                                        </svg>
