                    ...
                    <form className="space-y-4">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                                <label htmlFor="clientProfile" className="block text-sm font-medium text-gray-700 ml-0 sm:ml-10 w-full sm:w-40 mb-2 sm:mb-0">
                                    Client Profile
                                </label>
                                <select
                                    id="clientProfile"
                                    name="clientProfile"
                                    required
                                    className="flex-1 px-4 py-2 border rounded-md focus:ring-blue-500 focus:border-blue-500 border-gray-300 mr-0 sm:mr-5 min-w-0 w-full sm:w-auto"
                                >
                        ...
                        <div className="relative my-10">
                            ...
                            <span className="absolute left-1/2 -translate-x-1/2 -top-3 bg-white bg-opacity-80 px-4 text-lg font-semibold text-gray-700">
                                Contact information
                            </span>
                        </div>
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center mb-4 ml-0 sm:ml-10">
                            <label htmlFor="address" className="block text-sm font-medium text-gray-700 w-full sm:w-40 mb-2 sm:mb-0">
                                Address :
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                            <label htmlFor="telephone" className="block text-sm font-medium text-gray-700 ml-0 sm:ml-10 w-full sm:w-40 mb-2 sm:mb-0">
                                Telephone No :
                            </label>
                            <input
                                type="tel"
                                id="telephone"
                                name="telephone"
                                className="flex-1 px-4 py-2 border rounded-md focus:ring-blue-500 focus:border-blue-500 mr-0 sm:mr-5 border-gray-300 min-w-0 w-full sm:w-auto"
                            />
                        </div>
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                            <label htmlFor="cellphone" className="block text-sm font-medium text-gray-700 ml-0 sm:ml-10 w-full sm:w-40 mb-2 sm:mb-0">
                                Cellphone No :
                            </label>
                            <input
                                type="tel"
                                ...
                                name="cellphone"
                                required
                                className="flex-1 px-4 py-2 border rounded-md focus:ring-blue-500 mr-0 sm:mr-5 focus:border-blue-500 border-gray-300 min-w-0 w-full sm:w-auto"
                            />
                        </div>
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                            <label htmlFor="occupation" className="block text-sm font-medium text-gray-700 ml-0 sm:ml-10 w-full sm:w-40 mb-2 sm:mb-0">
                                Occupation :
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                            <label htmlFor="position" className="block text-sm font-medium text-gray-700 ml-0 sm:ml-10 w-full sm:w-40 mb-2 sm:mb-0">
                                Position :
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                            <label htmlFor="institution" className="block text-sm font-medium text-gray-700 ml-0 sm:ml-10 w-full sm:w-40 mb-2 sm:mb-0">
                                Institution :
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                            <label htmlFor="email" className="block text-sm font-medium ml-0 sm:ml-10 text-gray-700 w-full sm:w-40 mb-2 sm:mb-0">
                                Email Address :
                            </label>
                            <input
                                type="email"
